    ...
    return (
        <>
            <form onSubmit={handleSubmit}>
                ...
                <br />
                <textarea value={task.text} onChange={(e) => setTask({ ...task, text: e.target.value })} defaultValue="Add a new task!" />
                <br />
                <label>Add an image to your task!</label>
                <br />
                <input value={task.image} onChange={(e) => setTask({ ...task, image: e.target.value })} defaultValue="Add an image!" />
                <br />
